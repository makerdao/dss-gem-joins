...
// File @openzeppelin/contracts/math/SafeMathBal.sol@v3.0.1
 ...
 * `SafeMathBal` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
...
library SafeMathBal {
    ...
    function add(uint256 a, uint256 b) internal pure returns (uint256) {
        uint256 c = a + b;
        require(c >= a, "SafeMathBal: addition overflow");
    ...
    function sub(uint256 a, uint256 b) internal pure returns (uint256) {
        return sub(a, b, "SafeMathBal: subtraction overflow");
    }
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        uint256 c = a * b;
        require(c / a == b, "SafeMathBal: multiplication overflow");
    ...
    function div(uint256 a, uint256 b) internal pure returns (uint256) {
        return div(a, b, "SafeMathBal: division by zero");
    }
    ...
    function mod(uint256 a, uint256 b) internal pure returns (uint256) {
        return mod(a, b, "SafeMathBal: modulo by zero");
    }
 ...
 * Since it is not possible to overflow a 256 bit integer with increments of one, `increment` can skip the {SafeMathBal}
 * overflow check, thereby saving gas. This does assume however correct usage, in that the underlying `_value` is never
 * directly accessed.
 */
library Counters {
    using SafeMathBal for uint256;
    ...
    function increment(Counter storage counter) internal {
        // The {SafeMathBal} overflow check can be skipped here, see the comment at the top
        counter._value += 1;
    }
...
contract BAL is AccessControl, ERC20Snapshot {
